  ...
  const services = [
    {
      ...
      description:
        "Custom mobile apps, web applications, and AI solutions built with cutting-edge technology",
    ...
    },
    {
      ...
      description:
        "Comprehensive e-learning courses and hands-on internships to boost your career",
    ...
    },
    {
      ...
      title: "Internships",
      description:
        "Real-world experience programs that bridge the gap between education and industry",
    ...
    },
    {
      ...
      description:
        "Connect top tech talent with leading companies for perfect career matches",
    ...
    },
    {
      ...
      description:
        "Engaging digital content creation including educational materials and entertainment",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              From software development to digital marketing, Qulas provides
              comprehensive tech solutions that drive business growth and
              individual success.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-qulas-blue hover:bg-gray-100 font-semibold px-8 py-4 text-lg"
              >
                Explore Services
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-qulas-blue font-semibold px-8 py-4 text-lg"
              >
                Start Your Journey
              </Button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              We offer end-to-end solutions across multiple domains to help
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      ...
                      ensure your projects stay ahead of the curve.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Our diverse portfolio and satisfied clients speak to our
      ...
      <section className="py-20 bg-gradient-to-r from-qulas-blue to-qulas-purple">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Join hundreds of satisfied clients who have chosen Qulas for their
