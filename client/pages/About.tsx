          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                ...
                technology solutions and comprehensive digital services
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Founded in 2019, Qulas emerged from a simple yet powerful
                  vision: to bridge the gap between cutting-edge technology and
                  real-world business needs. What started as a small team of
                  passionate developers has grown into a comprehensive
                  technology partner serving clients across the globe.
                </p>
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  Today, we pride ourselves on being more than just a service
                  provider. We're your strategic partner in digital
                  transformation, offering everything from custom software
                  development to comprehensive training programs that prepare
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader>
                  <CardTitle className="text-2xl text-qulas-blue">
                    Our Mission
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    by providing comprehensive services that range from software
                    development to education and career advancement. We aim to
                    empower businesses and individuals to thrive in the digital
                    age.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader>
                  <CardTitle className="text-2xl text-qulas-purple">
                    Our Vision
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 leading-relaxed">
                    To become the leading global platform that connects
                    technology innovation with human potential, creating a world
                    where every business can leverage advanced digital solutions
                    and every individual can access world-class tech education
              ...
              {teamMembers.map((member, index) => (
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-qulas-blue font-medium mb-3">
                      {member.role}
                    </p>
