...
export default function Careers() {
  ...
  const jobListings = [
    {
      ...
      description:
        "We're looking for an experienced full stack developer to join our engineering team and help build cutting-edge applications.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Join our marketing team to develop and execute digital marketing strategies that drive growth and engagement.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Help us build the next generation of AI-powered solutions and advance our machine learning capabilities.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Build and maintain our infrastructure, automate deployments, and ensure scalability and reliability.",
      requirements: [
    ...
    },
    {
      ...
      salary: "$25 - $40/hour",
      description:
        "Create compelling content for our blog, social media, and marketing materials.",
      requirements: [
    ...
    },
    {
      ...
      salary: "$30 - $40/hour",
      description:
        "Join our team as an intern and gain hands-on experience in software development.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Drive business growth by identifying opportunities and building strategic partnerships.",
      requirements: [
  ...
  const companyBenefits = [
    ...
    },
    {
      ...
      description: "Competitive salaries and equity participation",
    },
  ];
        ...
        <section className="relative bg-gradient-to-br from-qulas-blue via-purple-600 to-qulas-purple text-white py-20 overflow-hidden">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
              ...
              opportunities and be part of an innovative team that's shaping
              tomorrow.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-qulas-blue hover:bg-gray-100"
              >
                View Open Positions
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-gray-600 mb-8">
                  Showing {filteredJobs.length} of {jobListings.length}{" "}
                  positions
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {filteredJobs.map((job) => (
                <Card
                  key={job.id}
                  className={`border-0 shadow-lg hover:shadow-xl transition-all duration-300 ${job.featured ? "ring-2 ring-qulas-blue/20" : ""}`}
                >
                  <CardContent className="p-6">
