                  ...
                  <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        >
                          I agree to be contacted by Qulas regarding my inquiry
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Most projects can begin within 1-2 weeks after contract
                    signing and requirements gathering.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Yes, we provide comprehensive maintenance and support
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    We offer both fixed-price and hourly billing depending on
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Absolutely! We excel at remote collaboration and use modern
