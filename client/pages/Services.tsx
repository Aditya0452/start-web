  ...
  const services = [
    {
      ...
      description:
        "Custom solutions tailored to your business needs with cutting-edge technology",
      subServices: [
    ...
    },
    {
      ...
      description:
        "Comprehensive e-learning courses and certification programs to advance your career",
      subServices: [
    ...
    },
    {
      ...
      title: "Internships",
      description:
        "Real-world experience programs connecting students with industry opportunities",
      subServices: [
        "Paid Internships",
    ...
    },
    {
      ...
      title: "E-books",
      description:
        "Digital content creation including educational materials and entertainment comics",
      subServices: [
        "Educational E-books",
        "Comic Creation",
        "Digital Publishing",
    ...
    },
    {
      ...
      description:
        "Creative advertising solutions to boost your brand visibility and engagement",
      subServices: [
        "Creative Design",
        "Campaign Management",
        ...
        <section className="relative bg-gradient-to-br from-qulas-blue via-purple-600 to-qulas-purple text-white py-20 overflow-hidden">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
              From cutting-edge software development to strategic digital
              marketing, we provide end-to-end solutions for your business
              growth
            </p>
            <Button
              size="lg"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {services.map((service, index) => (
                <Card
                  key={index}
                  className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 border-0 shadow-lg"
                >
                  {service.popular && (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  24/7 customer support and dedicated project managers for every
                  client
                </p>
              </div>
        ...
        <section className="py-20 bg-gradient-to-r from-qulas-blue to-qulas-purple">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-white/90 mb-8">
              Contact our team today to discuss your project requirements and
              get a custom quote
            </p>
