      ...
      <div className="relative min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4 py-12 overflow-hidden">
        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Sign in to your Qulas account to continue
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-sm text-qulas-blue hover:underline">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <Link to="/signup" className="text-qulas-blue hover:underline font-medium">
                Sign up here
              </Link>
            </div>
          </CardContent>
